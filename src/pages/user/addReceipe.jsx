  ...
  return (
    <>
      ...
      <form
        ...
        className={`w-full max-w-md mx-auto p-4 sm:p-6 rounded-3xl shadow-md transition-colors duration-300 ${isDark ? "bg-gray-900 text-white" : "bg-white text-gray-900"
          }`}
      >
        <h2 className="text-2xl font-semibold mb-2 text-center">Add Recipe</h2>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border transition ${isDark ? "bg-gray-800 border-gray-600 text-white" : "border-gray-300"
              }`}
        ...
        <div className="mb-5">
          ...
          <select
            ...
            className={`w-full px-4 py-3 rounded-lg border ${isDark ? "bg-gray-800 border-gray-600 text-white" : "border-gray-300"
              }`}
            required
          >
        ...
        <button type="submit" className="w-full py-3 mt-2 mb-10 bg-blue-500 text-white font-semibold rounded-2xl hover:bg-blue-600 transition-all">
          Submit Recipe
        </button>
      </form>
    </>
